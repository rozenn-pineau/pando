...
my $minCoverage = 192; # minimum number of sequences; DP, 192 = 2X, N = 96 trees
...
my $miss = 20; # maximum number of individuals with no data, 20% of N, 80% with data
my $d;
...
$in =~ m/^([a-zA-Z0-9\_\-\/]+\.vcf)$/ or die "Failed to match the variant file\n";
